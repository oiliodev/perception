			...
			<div class="average_commentlist_secton">
				<ul>
					<li>5 
						...
						<?php if(isset($product->rating_counts['5'])) { echo $product->rating_counts['5']; } else { echo '0'; } ?>
					</li>
					<li>4
					 ...
					 <?php if(isset($product->rating_counts['4'])) { echo $product->rating_counts['4']; } else { echo '0'; } ?></li>
					<li>3 
					...
					<?php if(isset($product->rating_counts['3'])) { echo $product->rating_counts['3']; } else { echo '0'; } ?></li>
					<li>2 
					...
					<?php if(isset($product->rating_counts['2'])) { echo $product->rating_counts['2']; } else { echo '0'; } ?></li>
					<li>1 
					...
					<?php if(isset($product->rating_counts['1'])) { echo $product->rating_counts['1']; } else { echo '0'; } ?></li>
				</ul>
			</div>
			<div class="commentlist_secton">
