...
if ($vendor) :
    ...
    ?>
    <div class="wcmp_headding2"><span><?php _e('General', 'dc-woocommerce-multi-vendor'); ?></span></div>
    <form method="post" name="shop_settings_form" class="wcmp_shop_settings_form">
        ...
        <div class="wcmp_headding2 moregap"><span><?php _e('Media Files', 'dc-woocommerce-multi-vendor'); ?></span></div>
