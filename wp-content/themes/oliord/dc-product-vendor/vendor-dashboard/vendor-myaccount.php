<?php
/*
 * The template for displaying vendor myaccount
 * Override this template by copying it to yourtheme/dc-product-vendor/vendor-dashboard/myaccount.php
 *
...
if (is_user_wcmp_vendor($user->ID)) :
    ...
    <div class="wcmp_tab">
        ...
        <div class="wcmp_tabbody"  id="today" >
            ...
            <div class="clear"></div>
            <h3 class="wcmp_black_headding"><span><?php echo __('Sales', 'dc-woocommerce-multi-vendor'); ?></span></h3>
            ...
            <div class="wcmp_table_loader">
                <div class="ajax_loader_class_msg"><img src="<?php echo $WCMp->plugin_url ?>assets/images/fpd/ajax-loader.gif" alt="ajax-loader" /></div>
                <div class="wcmp_showing-product">
            ...
            <h3 class="wcmp_black_headding"><span><?php echo __('Pending Shipping', 'dc-woocommerce-multi-vendor'); ?></span></h3>
            <div class="wcmp_table_holder">
            ...
            <div class="wcmp_table_loader">
                <div class="ajax_loader_class_msg"><img src="<?php echo $WCMp->plugin_url ?>assets/images/fpd/ajax-loader.gif" alt="ajax-loader" /></div>                
                <div class="wcmp_showing-product">
					<?php echo __('Showing Results', 'dc-woocommerce-multi-vendor'); ?> 
                <span> <span class="wcmp_front_count_first_num_today_ps"><?php echo $number_of_pending_shipping_show_today; ?></span> <?php echo __(' out of ', 'dc-woocommerce-multi-vendor'); ?> <?php echo $number_of_pending_shipping_whole_today; ?></span>
                </div>
                <?php if ($number_of_pending_shipping_whole_today > 6) { ?>
					<button class="wcmp_black_btn wcmp_frontend_pending_shipping_show_more_button" element-data="pending_shipping_today_more" style="float:right"><?php echo __('Show More', 'dc-woocommerce-multi-vendor'); ?></button>
				<?php } ?>
                <div class="clear"></div>
            </div>
            <?php endif; ?>
