...
$unique_id = esc_attr( uniqid( 'search-form-' ) ); 
 ...
 <style>
	...
	<div id="primary" class="content-area home-Member-pad deal-of-day">
		<main id="main" class="site-main" role="main">	
			...
			<div class="col-md-9 clearfix how-it-work-section" id="how-it-works">
<h3>How it Works</h3>
				<div class="row">
