...
<link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/datepicker.css"  />	
					...
					<div class="user-profile float-left">
						...
						<?php /*if(is_user_logged_in()) {
							...
							if($attachment_url == ''){
								...
								<li class="sign-up-btn sign--up-hader"><a data-toggle="tooltip" data-placement="top" title="My Account" href="<?php echo $dashboard_page_link; ?>"><?php _e('','olio'); ?>
