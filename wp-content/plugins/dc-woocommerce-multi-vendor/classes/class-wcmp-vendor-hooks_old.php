...
class WCMp_Vendor_Hooks {
    ...
    function __construct() {
        ...
        add_action('wcmp_vendor_dashboard_report2_endpoint', array(&$this, 'wcmp_vendor_dashboard_report2_endpoint'));
        ...
        //add_action('wcmp_vendor_dashboard_vendor-newmenu_endpoint', array(&$this, 'wcmp_vendor_dashboard_vendor_newmenu_endpoint'));
    ...
    public function wcmp_create_vendor_dashboard_navigation($args = array()) {
        ...
        $vendor_nav = array(
            ...
            'report2' => array(
                'label' => __('Orders 2 ', 'dc-woocommerce-multi-vendor')
                , 'url' => wcmp_get_vendor_dashboard_endpoint_url(get_wcmp_vendor_settings('wcmp_vendor_report2_endpoint', 'vendor', 'general', 'report2'))
                , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_orders_capability', true)
                , 'position' => 50
                , 'submenu' => array()
                , 'link_target' => '_self'
            ...
            'vendor-signout' => array(
                ...
                , 'url' => esc_url(wp_logout_url(site_url()) )
                , 'capability' => true
                , 'position' => 80
                , 'submenu' => array()
                , 'link_target' => '_self'
            ...
            'vendor-newmenu' => array(
                'label' => __('New Menu', 'dc-woocommerce-multi-vendor')
                , 'url' => wcmp_get_vendor_dashboard_endpoint_url(get_wcmp_vendor_settings('wcmp_vendor_newmenu_endpoint', 'vendor', 'general', 'vendor-newmenu'))
                , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_vendor_newmenu_capability', true)
                , 'position' => 90
                , 'submenu' => array()
                , 'link_target' => '_self'
                , 'nav_icon' => 'dashicons-migrate'
     ...
     * @global object $WCMp
     */
    public function wcmp_vendor_dashboard_report2_endpoint() {
		echo 'sumra';
	}
    ...
    //~ public function wcmp_vendor_dashboard_vendor_newmenu_endpoint() {
		//~ echo 'Menu New Page';
