...
function ADDTOANY_SHARE_SAVE_BUTTON( $args = array() ) {
	...
	if ( ! $args['no_universal_button'] ) {
		...
		$button_html = $html_container_open . $html_wrap_open . '<a title="Share on social sites" class="a2a_dd' . $button_class . $button_additional_classes . ' addtoany_share_save" href="https://www.addtoany.com/share' .$button_href_querystring . '"'
